...
public class GameLogic {
    public static void GameRun(){
        ...
        TicTacToe.InitializeTable table = new TicTacToe.InitializeTable(); //initialize the game, dont touch InitializeTable.java
        TicTacToe.GameStatus status = new TicTacToe.GameStatus(); //check the game status
